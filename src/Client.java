...
public class Client {
	...
	// ensemble des noeuds r�cup�r�s gr�ce au lookup
	 ...
	 * @param args
	 * 
	 *            Un argument attendu = nombre de noeuds � lookup.
	 * 
	 */
	public static void main(String[] args) {
		...
		// on r�cup�re l'argument cens� �tre le nombre de noeud � lookup
		String n = args[0];
		...
		/*
		 * Initialisation termin�e, affichage de la partie interactive
		 */
		...
		while (true) {
			try {
				...
				default:
					System.out
							.println("Unknown command, type help to list them.");
					break;
				}
			} catch (IOException e) {
				e.printStackTrace();
	 ...
	 *             Cr�er l'arbre vu en TP pour les tests Rq : il doit y avoir 6
	 *             noeuds ou plus.
	 */
	...
	/**
	 * @throws RemoteException
	 *             Listing des noeuds disponnibles, de leur p�re et de leur fils
	 */
