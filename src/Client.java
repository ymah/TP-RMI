...
public class Client {
	...
	public static void main(String[] args) {
		if (args.length != 2) {
			System.err.println("USAGE : java Client [nombre de noeud] [adresse du registre]\nie. java Client 6 rmi://localhost:1099");
			return;
		}
	...
	/**
	 * Remplissage des tableaux cmd et cmdOpt
	 * cmd : liste des commandes utilisables
	 * cmdOpt : USAGE de chaque commande
	 */
	 ...
	 * Créer l'arbre vu en TP pour les tests
	 * Rq : il doit y avoir 6 noeuds ou plus.
	 */
...
//	}
	 ...
	 * @param pere
	 * @throws RemoteException
	 * Ajout de "pere" en tant que pere du noeud "fils"
	 * + de "fils" en tant que fils du noeud "pere"
	 */
	 ...
	 * @param fils
	 * @throws RemoteException
	 * Ajout de "fils" en tant que fils du noeud "pere"
	 * + de "pere" en tant que pere du noeud "fils"
	 */
	...
	/**
	 * @throws RemoteException
	 * Listing des noeuds disponnibles, de leur père et de leur fils
	 */
